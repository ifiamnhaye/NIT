...
Table of Contents
Task	Title
1	Checking Inodes with ls -li
2	Understanding Directory Metadata with ls -ld
3	Comparing ls -l vs ls -ld
4	Checking Filesystem Inode Usage
5	Creating Files and Watching Inodes Change
...
In Linux, every file and directory has an inode. An inode is a special data structure that stores:
...
Why can a system run out of inodes?
What command shows inode usage?
Why can df -h show free space but file creation still fail?
Final Summary
Run:
...
permissions
size
owner Post the results of your findings on LinkedIn

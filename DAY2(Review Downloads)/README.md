...
Table of Contents
Task	Title	Summary
1	Access your Virtual Machine	Introduction to Unix/Linux
2	What is Linux Shell?	Login to Virtual Machine and access the Linux Command Line (CLI)
3	Register a GitHub Account	Create your GitHub account
4	Register or Update LinkedIn	Create or improve LinkedIn profile
5	Install Git Bash	Install Git Bash on Windows
6	Visual Studio Code	Install Visual Studio Code
7	Discord	Install and join Discord
...
Accessing Xen-Orchestra Click the link below to access the login-page
Xen-Orchestra
...
Username:
Password:
Navigating your Virtual Machine (VM) Console Click on the virtual machine that has a "green" dot:\
...
Let us fix this IPv6 overflow issue. When we learn Networking we will come to understand:
ip4 vs ipv6
...
Task 4 - Register or Update Linkedin Click on the link
